...
import { Mail, Lock, User, Phone as PhoneIcon, Bot, ArrowRight } from 'lucide-react';
...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      {/* Floating orbs */}
      <div className="absolute top-20 right-20 w-72 h-72 bg-violet-400/30 rounded-full blur-3xl animate-pulse-slow" />
      <div className="absolute bottom-20 left-20 w-96 h-96 bg-brand-400/20 rounded-full blur-3xl animate-pulse-slow delay-1000" />
      <div className="absolute top-1/3 right-1/3 w-64 h-64 bg-cyan-400/20 rounded-full blur-3xl animate-pulse-slow delay-500" />
      ...
      <div className="relative z-10 w-full max-w-md mx-4 animate-slide-up">
        <div className="glass-strong rounded-3xl p-8 shadow-2xl">
          ...
          <p className="text-sm text-center text-surface-500 dark:text-surface-400 mb-6">
            Set up your AI-powered call assistant
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Input label="Phone (optional)" type="tel" icon={PhoneIcon} placeholder="+1 555 000 0000" value={phone} onChange={(e) => setPhone(e.target.value)} />
